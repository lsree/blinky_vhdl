...
HD_PWD='/home/locch/Documents/Zedboard/blink_vhdl/blink_vhdl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blink_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blink_vhdl.tcl -notrace
