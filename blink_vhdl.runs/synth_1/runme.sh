...
HD_PWD='/home/locch/Documents/Zedboard/blink_vhdl/blink_vhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blink_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blink_vhdl.tcl
